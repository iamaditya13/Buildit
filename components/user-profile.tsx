    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-12">
      ...
      <div className="text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mt-4 text-sm">
          ...
          {(initialProfile as any).linkedin_url && (
            <a href={(initialProfile as any).linkedin_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-muted-foreground hover:text-primary transition-colors">
