    ...
    >
      ...
      <FieldGroup>
        ...
        <Input
          ...
          type="text"
          placeholder="A one-liner about your project (max 200 chars)"
        ...
        <p className="text-xs text-muted-foreground mt-1">
          {formData.shortDescription.length}/200 — Shows on cards and the leaderboard
        </p>
      </FieldGroup>
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {tags.map(tag => (
            <motion.span
              ...
              className="tech-pill text-sm px-3 py-1 rounded-lg flex items-center gap-1.5"
            >
              {tag}
              <button
                type="button"
      ...
      <FieldGroup>
        <FieldLabel htmlFor="imageUrl">Project Screenshot URL</FieldLabel>
        <Input
          id="imageUrl"
          name="imageUrl"
          type="url"
      ...
      <Button
        type="submit"
        disabled={loading}
        className="w-full bg-accent text-accent-foreground hover:bg-accent/90 h-12 text-base font-semibold rounded-lg glow-violet-sm"
      >
